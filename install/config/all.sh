...
run_logged $OMARCHY_INSTALL/config/i2c-display-control.sh
...
run_logged $OMARCHY_INSTALL/config/hardware/apple/fix-suspend.sh
run_logged $OMARCHY_INSTALL/config/hardware/apple/fix-fan.sh
